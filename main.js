...
app.post('/api/servers', (req, res) => {
  const { name, ip, mac, autoMode, allowShutdown } = req.body;
  if (Debugging) {console.log("DEBUG: API CALL: POST /api/servers with data: ", name, " | ", ip, " | ", mac, " | ", autoMode, " | ", allowShutdown )}
  servers.push({ name, ip, mac, autoMode, allowShutdown });
